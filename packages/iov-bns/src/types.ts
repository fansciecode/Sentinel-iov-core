...
import { BcpCoin, FullSignature, FungibleToken,Nonce ,PayVpnService ,TokenTicker } from "@iov/bcp-types";
import {
  Algorithm,
  PrivateKeyBundle,
  PrivateKeyBytes,
...
export const encodeData = (data: PayVpnService) =>
  codecImpl.x.msgData.create({
    MsgData :data as Uint8Array,
