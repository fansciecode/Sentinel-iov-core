  ...
  crypto.PublicKey = (function () {
    ...
    PublicKey.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.crypto.PublicKey();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
  ...
  crypto.PrivateKey = (function () {
    ...
    PrivateKey.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.crypto.PrivateKey();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
  ...
  crypto.Signature = (function () {
    ...
    Signature.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.crypto.Signature();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
  ...
  sigs.UserData = (function () {
    ...
    UserData.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.sigs.UserData();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
  ...
  sigs.StdSignature = (function () {
    ...
    StdSignature.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.sigs.StdSignature();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
...
$root.x = (function () {
  ...
  x.msgData = (function () {
    ...
    msgData.prototype.MsgData = Uint8Array;
    ...
    msgData.encode = function encode(message, writer) {
      ...
      if (message.MsgData != null && message.hasOwnProperty("MsgData"))
        writer.uint32( /* id 1, wireType 0 =*/ 8).Uint8Array(message.MsgData);
    ...
    msgData.verify = function verify(message) {
      if (typeof message !== "object" || message === null)
        return "object expected";
      //   if (message.MsgData != null && message.hasOwnProperty("MsgDatas"))
      //     if (!$util.isBytes(message.whole) && !(message.whole && $util.isInteger(message.whole.low) && $util.isInteger(message.whole.high)))
    ...
    msgData.fromObject = function fromObject(object) {
      if (object instanceof $root.x.msgData)
        return object;
      var message = new $root.x.msgData();
  ...
  app.ResultSet = (function () {
    ...
    ResultSet.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.app.ResultSet();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
  ...
  escrow.Escrow = (function () {
    ...
    Escrow.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.escrow.Escrow();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
  ...
  escrow.CreateEscrowMsg = (function () {
    ...
    CreateEscrowMsg.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.escrow.CreateEscrowMsg();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
  ...
  escrow.ReleaseEscrowMsg = (function () {
    ...
    ReleaseEscrowMsg.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.escrow.ReleaseEscrowMsg();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
  ...
  escrow.ReturnEscrowMsg = (function () {
    ...
    ReturnEscrowMsg.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.escrow.ReturnEscrowMsg();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
  ...
  escrow.UpdateEscrowPartiesMsg = (function () {
    ...
    UpdateEscrowPartiesMsg.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.escrow.UpdateEscrowPartiesMsg();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
  ...
  namecoin.Wallet = (function () {
    ...
    Wallet.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.namecoin.Wallet();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
  ...
  namecoin.Token = (function () {
    ...
    Token.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.namecoin.Token();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 2:
  ...
  namecoin.NewTokenMsg = (function () {
    ...
    NewTokenMsg.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.namecoin.NewTokenMsg();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
  ...
  namecoin.SetWalletNameMsg = (function () {
    ...
    SetWalletNameMsg.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.namecoin.SetWalletNameMsg();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
